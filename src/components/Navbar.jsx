...
const Navbar = ({ setArticles }) => {
    ...
    return (
        <div className='fixed w-full bg-white dark:bg-blue-950 z-100 shadow-md'>
            <div className='max-w-7xl mx-auto px-4 py-3 flex items-center justify-between'>
                ...
                <div className='flex items-center justify-center gap-4'>
                    ...
                    <button onClick={toggleTheme} className='bg-gray-200 dark:bg-blue-900 dark:text-gray-200  px-3 py-2 rounded-lg cursor-pointer'>
                        {
